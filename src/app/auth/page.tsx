      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-[#d9cdbf] bg-white p-8 shadow-sm sm:p-10">
          ...
          <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); router.push("/shop"); }}>
            ...
            <button
              type="submit"
              className="mt-2 h-12 w-full rounded-lg bg-gradient-to-r from-[#d4a574] to-[#b8956a] text-sm font-medium tracking-widest text-[#1a0f0a] uppercase transition-all duration-300 hover:shadow-lg hover:shadow-[#d4a574]/25"
              style={{ fontFamily: "'Jost', sans-serif" }}
            >
          ...
          <div className="my-6 flex items-center gap-4">
            ...
            <span className="text-xs font-light tracking-widest text-[#b0a08f] uppercase" style={{ fontFamily: "'Jost', sans-serif" }}>
              or
            </span>
            <div className="h-px flex-1 bg-[#d9cdbf]" />
          </div>
          ...
          <button
            type="button"
            className="flex h-12 w-full items-center justify-center gap-3 rounded-lg border border-[#d9cdbf] bg-white text-sm font-light tracking-wide text-[#7b6a59] transition-colors hover:bg-[#fbf9f6]"
            style={{ fontFamily: "'Jost', sans-serif" }}
          >
